...
export default class State {
    ...
    changelog: Changelog;
    draft: Draft;
    // TODO locale: LocaleOptions;
    experiments: Experiments;
    layout: Layout;
    // TODO notifications: NotificationOptions;
    queue: MessageQueue;
    settings: Settings;
    sync: Sync;
    plugins: Plugins;
    ...
    constructor() {
        ...
        // TODO this.locale = new LocaleOptions();
        this.experiments = new Experiments();
        this.layout = new Layout();
        // TODO this.notifications = new NotificationOptions(this);
    ...
    onPacket(packet: ClientboundNotification) {
        if (packet.type === "UserSettingsUpdate") {
            try {
                ...
                // TODO reportError(err as any, "failed_sync_apply");
            }
        }
    }
    ...
    async hydrate() {
        ...
        // TODO clientController.hydrate(this.auth);
    }
